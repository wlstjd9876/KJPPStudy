...
<!-- 왼쪽에 보여지는 창  -->
<div class='left-box'>
<div class="map_wrap" class="bg_white">
<div id='map' style=" margin-top:40px; margin-left:40px; width:100%;height:600px;position:relative;overflow:hidden;"><!-- 맵 여기에 넣음 --></div>

    <div id="menu_wrap" class="bg_white">
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="종각 kh정보교육원" id="keyword" size="15"> 
